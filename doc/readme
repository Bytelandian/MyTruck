...
3. Client side Web-Application:
	...
	This website helps the client to find out about truck drivers that can help them transport their goods between their desired locations. 	There are different ways in which they can find such a driver.
